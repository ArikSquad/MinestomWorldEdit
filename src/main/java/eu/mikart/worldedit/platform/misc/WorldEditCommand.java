package eu.mikart.worldedit.platform.misc;
...
public class WorldEditCommand extends Command {
    ...
    private boolean condition(final CommandSender sender, final String command) {
        ...
        return cmd.getCondition().satisfied(store) && MinestomWorldEdit.getInstance().getPermissionHandler().test(sender, command);
    }
